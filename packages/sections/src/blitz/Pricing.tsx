...
import type { BlitzPricingProps } from "./schema";
...
export default function BlitzPricing({
  title = "Built to outperform. Priced to scale.",
  subtitle = "BlitzAPI is not just another data provider. It's the infrastructure behind thousands of GTM workflows",
  stats = [
    ...
    >
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 40px", position: "relative" }}>
        ...
        >
          ...
          <p style={{ fontSize: "16px", color: "#9ca3af", maxWidth: "500px", margin: "0 auto", lineHeight: 1.6 }}>
            {subtitle}
          </p>
        </motion.div>
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: `repeat(${mockup.labels?.length || 3}, 1fr)`, gap: "12px", marginBottom: "16px" }}>
            {mockup.labels?.map((label, i) => (
              <div
                key={`${label}-${i}`}
              ...
              >
                ...
                <div style={{ height: "8px", width: "50%", background: "#e5e7eb", borderRadius: "4px", marginBottom: "8px" }} />
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <span style={{ fontSize: "16px", fontWeight: 600, color: "#111827" }}>{costLabel}</span>
              <div
                style={{
                  width: "40px",
                  height: "22px",
            ...
            <span style={{ fontSize: "20px", fontWeight: 700, color: "#111827" }}>{costValue}</span>
          </div>
        </motion.div>

        {/* Stats row */}
        <div
          style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "32px", textAlign: "left" }}
      ...
      <style>{`
        ...
        @media (max-width: 576px) {
          .pricing-stats-grid { grid-template-columns: 1fr !important; }
          .cost-bar { width: 80px !important; }
        }
      `}</style>
    </section>
  );
